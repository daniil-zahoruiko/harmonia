...
export const Nav = ({setPage}) =>{
    ...
    return(
        <nav className="desktop_nav">
            <ul>
                <li onClick={()=>setCurrentPage("home")} className="nav_outer nav_logo">
                    <div>
                        <p>Project name</p>
                    </div>
                </li>
                <li onClick={()=>setCurrentPage("library")} className="nav_li nav_left">
                    <p>
                        Library
                    </p>
                </li>
                <li onClick={()=>setCurrentPage("user_account")}>
                ...
                <li onClick={()=>setCurrentPage("discover")} className="nav_li nav_right">
                    <p>
                        Discover
                    </p>
                </li>
                <li onClick={()=>setCurrentPage("settings")} className="nav_outer nav_settings">
                    <div>
